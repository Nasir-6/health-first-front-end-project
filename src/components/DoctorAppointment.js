...
const DoctorAppointment = ({oneDoctorAppointment, handleDeleteAppointment}) => {
  return (
    <article className='doctor-Appointment'>
      <div className='delete-btn-position'><DeleteButton deleteButtonClick={handleDeleteAppointment}/></div>
